...
[![Python Version](https://img.shields.io/badge/python-3.10%2B-blue)](https://www.python.org/) [![LLM Powered](https://img.shields.io/badge/LLM-powered-FF6F61)](https://platform.openai.com/)
...
| 对话引擎   | 单一 Agent + RAG | 基于文档检索与工具调用生成回答，确保信息来源可控 |
...
4. 创建提示词文件prompts/*_prompt.txt（必须存在，否则程序启动时报错）
```
